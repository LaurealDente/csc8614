...
def finalize(state: AgentState) -> AgentState:
    ...
    if intent == "reply":
        ...
        if cits:
            ...
            state.final_text = state.draft_v1.strip() or "Pas assez d'information"  # TODO: fallback reply

    elif intent == "ask_clarification":
        state.final_kind = "clarification"
        state.final_text = state.draft_v1.strip() or "Bonjour, précisez s'il vous plait"  # TODO: fallback questions
        ...
        state.final_text = "Pas de réponse nécessaire"  # TODO: texte minimal ignore
