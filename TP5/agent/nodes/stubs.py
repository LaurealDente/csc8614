...
def stub_reply(state: AgentState) -> AgentState:
    ...
    state.draft_v1 = "Reponse mail"  # TODO: message minimal (sera remplacé plus tard)
...
def stub_ask_clarification(state: AgentState) -> AgentState:
    ...
    state.draft_v1 = "Il me manque des informations"  # TODO: 1-2 questions génériques (sera remplacé plus tard)
...
def stub_escalate(state: AgentState) -> AgentState:
    ...
    state.actions.append({
        "type": "handoff_human",
        "summary": "Demande à un humain",   # TODO: résumé court pour escalade
    })
...
def stub_ignore(state: AgentState) -> AgentState:
    ...
    state.actions.append({
        "type": "ignore",
        "reason": "ignoré",  # TODO: raison courte (ex: hors périmètre)
    })
